...
<Dropdown text="Layouts">
    <Grid>
        <Element text="Container" element="div" disabled>
        ...
        <Element text="Item" element="div" disabled>
...
<Dropdown text="Text">
    <Grid>
        ...
        <Element text="Link" element="a" disabled>
...
<Dropdown text="Content">
    <Grid>
        <Element text="Markdown" element="markdown" disabled>
